...
namespace XNodeEditor {
    ...
    public class NodeEditor : XNodeEditor.Internal.NodeEditorBase<NodeEditor, NodeEditor.CustomNodeEditorAttribute, XNode.Node> {
        ...
        {
            var nodeTitleAttribute = target.GetType().GetCustomAttribute<XNode.Node.NodeTitleAttribute>();
        ...
        public virtual void OnHeaderGUI() {
            ...
            if (allowCustomName)
            {
                XNode.Node.NodeTitleAttribute attrib;
                var type = target.GetType();
                NodeEditorUtilities.GetAttrib(type, out attrib);
                string head = attrib == null ? target.name : attrib.title;
                var info = type.GetField("index");
                if (info != null)
                    head += $"_{info.GetValue(target)}";
